...
public class Constant {
    ...
    public static final String OTHER_BANK_TRANSFER_API = "https://api.flutterwave.com/v3/transfers";
    public static final String AUTHORIZATION = "FLWSECK-a8eb690cb47ede35f3d90d2946de2331-X";
